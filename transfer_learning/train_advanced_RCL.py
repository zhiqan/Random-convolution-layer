...
def parse_args():
    ...
    #parser.add_argument('--data_name', type=str, default='PU_type', help='the name of the data')
    parser.add_argument('--data_name', type=str, default='SEU', help='the name of the data')
    #parser.add_argument('--data_dir', type=str, default='E:\\研究数据\\德国帕恩大学轴承数据', help='the directory of the data')
    #parser.add_argument('--data_dir', type=str, default='E:\\研究数据\\HITdataset', help='the directory of the data')
    #parser.add_argument('--data_dir', type=str, default='D:\\参考文献\\UDTL-master\\datasets\\CWRU_Dataset', help='the directory of the data')
    parser.add_argument('--data_dir', type=str, default='D:\\参考文献\\UDTL-master\\datasets\\SEU', help='the directory of the data')
