xb_DE_time = X121_DE_time(1:120000); %121
xi_DE_time = X108_DE_time(1:120000); %108
xo_DE_time = X133_DE_time(1:120000); %133
...
save('0.014-Ball+Inner+Outer_1.mat','xbio_DE_time_1');
