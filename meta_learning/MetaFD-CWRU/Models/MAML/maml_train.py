...
vis = visdom.Visdom(env='7_12_AIML_T3-T2')
...
if __name__ == "__main__":
    ...
    if input('Train? y/n\n').lower() == 'y':
        ...
        path = r"D:\\论文+无监督下基于小样本数据的旋转机械故障诊断研究\\故障诊断例子\\MetaFD-main\\Models\\MAML\\5shot_MAML_7_12_seuT3-T2"
        Net.train(save_path=path, shots=5)
    ...
    if input('Test? y/n\n').lower() == 'y':
        ...
        load_path = r"D:\论文+无监督下基于小样本数据的旋转机械故障诊断研究\故障诊断例子\MetaFD-main\Models\MAML\5shot_MAML_7_12_seuT3-T2_ep100(1)"
        Net.test(load_path, inner_steps=10, shots=1)
        load_path = r"D:\论文+无监督下基于小样本数据的旋转机械故障诊断研究\故障诊断例子\MetaFD-main\Models\MAML\5shot_MAML_7_12_seuT3-T2_ep300"
