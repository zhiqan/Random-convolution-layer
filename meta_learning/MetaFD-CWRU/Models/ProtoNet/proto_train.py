...
if __name__ == "__main__":
    ...
    if input('Train? y/n\n').lower() == 'y':
        ...
        # Net.train(save_path=path, shots=5)
        Net = ProtoNet_learner(ways=6)  # T1
    ...
    if input('Test? y/n\n').lower() == 'y':
        ...
        load_path =  r"D:\\论文+无监督下基于小样本数据的旋转机械故障诊断研究\\故障诊断例子\\MetaFD-main\\Models\\ProtoNet\\5shot_ProtoNet_T2-T3_ep60(1)"
        Net.test(load_path, shots=1)
